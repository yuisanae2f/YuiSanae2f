...
var strArr = {
    span: [
        ...
        {
            ko: `입력된 인수들의 개수이자 <a href="#function.main.().argv">argv</a>의 길이입니다.`,
            en: ``
        },

        {
            ko: `아무런 인수가 들어가 있지 않은 경우에도 프로그램의 이름이 인수 그 자체가 되므로 기본값은 1이 됩니다.`,
            en: ``
        },

        {
            ko: `입력된 인수들은 공백 문자(스페이스바)로 구분된 문자열의 배열로써 <a href="#function.main.().argv" class="arg">argv</a>에 저장됩니다.`,
            en: ``
        },

        {
            ko: `외부 라이브러리에 저장된 요소를 가져와 사용할 수 있도록 합니다.`,
            en: ``
        },

        {
            ko: `시스템 헤더 파일, 즉 <a href="./ccpp/header.html" class="mark">컴파일러와 함께 제공되는 헤더 파일</a>을 포함시킬 때 사용됩니다.`,
            en: ``
        },

        {
            ko: `이 경우 컴파일러는 시스템 헤더 파일을 저장하는 데 사용하는 기본 검색 경로에서 헤더를 찾아 옵니다.`,
            en: ``
        },

        {
            ko: `사용자 정의된 라이브러리, 즉 커스텀 헤더 파일을 포함시킬 때 사용됩니다.`,
            en: ``
        },

        {
            ko: `절대 경로, 혹은 상대 경로에 있는 정보를 읽어 옵니다.`,
            en: ``
        },
